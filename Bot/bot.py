...
async def help(ctx):
    ...
    embedVar.add_field(
        name="!invite", value="Sends you the links to invite the bot to your own server & the official bot server", inline=False)
    embedVar.add_field(
        name="github", value="https://github.com/himanshu2406/Corona-Tracker", inline=False)
    embedVar.add_field(
